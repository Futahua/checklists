...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `7313025` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `7313025` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 118 files / 718 tests |
...
slice 7; keep every eventual mutation typed-unavailable until record-store cutover.
