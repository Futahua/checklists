...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `1081aa2` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `1081aa2` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 123 files / 736 tests |
...
slice 12; keep every eventual mutation typed-unavailable until record-store cutover.
