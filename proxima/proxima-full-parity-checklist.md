...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `a888988` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `a888988` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 124 files / 740 tests |
...
slice 13; keep every eventual mutation typed-unavailable until record-store cutover.
