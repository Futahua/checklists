...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `987daac` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `987daac` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 127 files / 754 tests |
...
slice 16; keep every eventual mutation typed-unavailable until record-store cutover.
