...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `35b20e4` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `35b20e4` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 128 files / 758 tests |
...
slice 17; keep every eventual mutation typed-unavailable until record-store cutover.
