...
| Suite at `425a631` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 217 files / 1448 tests; committer `2026-09-12T07:23:09+07:00`. At `8676dc3` the same steps were 217 files / 1447 tests, committer `2026-09-12T07:19:39+07:00`. One flake seen and re-checked: `tests/bridgeDisclosure.test.ts` hit its own 30 s bound in one bare full-suite run (exit 1, 30 198 ms) and passes alone in 227 ms and in the full suite on re-run, so the bound is too close to its own wait under load rather than a regression. At `dc675d9` the same steps were 216 files / 1443 tests, committer `2026-09-12T07:15:07+07:00`. At `4288b71` the same steps were 215 files / 1439 tests, committer `2026-09-12T07:12:32+07:00`. At `1b0094a` the same steps were 214 files / 1435 tests, committer `2026-09-12T07:08:43+07:00`. At `9e27cad` the same steps were 213 files / 1426 tests, committer `2026-09-12T07:04:53+07:00`. At `bede835` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 211 files / 1408 tests; committer `2026-09-12T06:50:27+07:00`. At `81e1ec4` the same steps were 211 files / 1405 tests, committer `2026-09-12T06:46:54+07:00`. At `38bd4ca` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 211 files / 1405 tests; committer `2026-09-12T06:46:54+07:00`. At `38bd4ca` the same steps were 211 files / 1402 tests, committer `2026-09-12T06:43:15+07:00`. At `8d5ec96` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 211 files / 1402 tests; committer `2026-09-12T06:43:15+07:00`. At `8d5ec96` the same steps were 210 files / 1399 tests, committer `2026-09-12T06:36:10+07:00`. At `bd61f60` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 210 files / 1399 tests; committer `2026-09-12T06:36:10+07:00`. At `bd61f60` the same steps were 209 files / 1395 tests, committer `2026-09-12T06:31:21+07:00`. At `f3f277a` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 209 files / 1395 tests; committer `2026-09-12T06:31:21+07:00`. At `f3f277a` the same steps were 208 files / 1390 tests, committer `2026-09-12T06:21:12+07:00`. At `16b443e` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 208 files / 1390 tests; committer `2026-09-12T06:21:12+07:00`. At `16b443e` the same steps were 207 files / 1387 tests, committer `2026-09-12T06:11:55+07:00`. At `38ce017` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 207 files / 1387 tests; committer `2026-09-12T06:11:55+07:00`. At `38ce017` the same steps were 206 files / 1381 tests, committer `2026-09-12T06:03:57+07:00`. At `dc82f11` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 206 files / 1381 tests; committer `2026-09-12T06:03:57+07:00`. At `dc82f11` the same steps were 206 files / 1378 tests, committer `2026-09-12T05:54:14+07:00`. At `da99863` | fixture generation 0, source/test typecheck 0, build 0, `git diff --check` 0, vitest 0 under **default parallelism**, 206 files / 1377 tests; committer `2026-09-12T05:50:08+07:00`. At `75091b0` the same steps were 206 files / 1377 tests, committer `2026-09-12T05:47:24+07:00`; at `2e7928d` 205 files / 1372 tests, committer `2026-09-12T05:43:38+07:00`; at `392a8e7` 205 files / 1372 tests, committer `2026-09-12T05:35:21+07:00`. At `9e20d39` the same steps were 204 files / 1365 tests, committer `2026-09-12T05:28:23+07:00`. At `d5fbc00` the same steps were 202 files / 1353 tests, committer `2026-09-12T05:22:12+07:00`. At `c5291f1` the same steps were 202 files / 1352 tests, committer `2026-09-12T05:03:47+07:00`; at `f8376eb` 201 files / 1346 tests, committer `2026-09-12T04:49:50+07:00`. At `327d90c` the same steps were 200 files / 1340 tests, committer `2026-09-12T04:40:33+07:00`. At `04d0bc4` the same steps were 199 files / 1335 tests, committer `2026-09-12T04:36:08+07:00`. At `9b197e2` the same steps were 198 files / 1330 tests, committer `2026-09-12T04:32:15+07:00`. At `e9117b2` the same steps were 197 files / 1325 tests, committer `2026-09-12T04:25:46+07:00`. At `9dcc5d6` the same steps were 196 files / 1322 tests, committer `2026-09-12T04:21:48+07:00`. At `e325f6e` the same steps were 195 files / 1315 tests, committer `2026-09-12T04:18:31+07:00`. At `08d31b5` the same steps were 194 files / 1307 tests, committer `2026-09-12T04:11:16+07:00`; at `6dfad33` 193 files / 1299 tests, committer `2026-09-12T04:05:45+07:00`; at `1029a25` 192 files / 1291 tests, committer `2026-09-12T03:59:36+07:00`; at `c74003f` 191 files / 1286 tests, committer `2026-09-12T03:54:01+07:00`. At `e4e319b` they were 189 files / 1271 tests, committer `2026-09-12T03:44:25+07:00`; at `9a04451` 188 files / 1269 tests, committer `2026-09-12T03:40:29+07:00`. At `18c2e48` they were 187 files / 1265 tests, committer `2026-09-12T03:37:24+07:00`; at `cab1627` 187 files / 1260 tests, committer `2026-09-12T03:31:18+07:00`. At `ed09e3d` they were 186 files / 1250 tests; committer `2026-09-12T03:25:34+07:00`. At `e62e8f4` the same steps were 186 files / 1246 tests, committer `2026-09-12T03:21:44+07:00`; at `abf8204` 186 files / 1245 tests, committer `2026-09-12T03:20:05+07:00`. At `e898a04` they were 185 files / 1235 tests; committer `2026-09-12T03:10:20+07:00`. At `d6e2b30` the same steps were 184 files / 1230 tests. At `06c0702` the same steps were 183 files / 1225 tests, at `738bb53` 182 / 1220, at `d9d8c5e` 181 / 1214, at `8dc3841` 180 / 1210, at `08e505d` 179 / 1207, at `215777a` 179 / 1205, at `ead7927` 179 / 1203, at `7f96a71` 179 / 1192, and at `ba50cc6` 178 / 1185, `3fa16bc` 178 / 1184, `8cadd24` 178 / 1172, `d21f434` 178 / 1167, `1ffdd55` 177 / 1147, `7825d20` 174 / 1105. **One test was load-sensitive and was fixed, not tolerated:** `tests/bridgeDisclosure.test.ts` starts a real bridge child process and allowed it five seconds to print `listening`; under parallel load that expired while the file passed alone in half a second, which is a flake that makes the whole suite untrustworthy. The bound is now thirty seconds. **The same flake class recurred and was fixed the same way at `d6e2b30`:** that file had raised its *bridge-start* bound to thirty seconds but left its three cases on vitest's five-second default, so with the suite at 184 files one case timed out under parallel load while passing alone. All three now carry `30_000`. The rule this keeps teaching: when a case spawns a process whose start it bounds, the case's own timeout must be at least that bound, or the bound is decoration. The slice-30 commit message says "177 files"; that is wrong — two existing files each gained a case, so the file count did not move then. At the last accepted point `97c9dd9`: 168 files / 1011 tests, Stage 8 focused 16 files / 105 tests, committer `2026-09-11T20:42:20+07:00` |
