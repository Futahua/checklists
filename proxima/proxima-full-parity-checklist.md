...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `92e4fa3` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `92e4fa3` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 125 files / 744 tests |
...
slice 14; keep every eventual mutation typed-unavailable until record-store cutover.
