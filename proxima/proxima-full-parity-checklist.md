...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `cb012d1` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `cb012d1` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 129 files / 762 tests |
...
slice 18; keep every eventual mutation typed-unavailable until record-store cutover.
