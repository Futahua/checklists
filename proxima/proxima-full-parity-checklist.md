...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `7d6ea75` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `7d6ea75` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 126 files / 749 tests |
...
slice 15; keep every eventual mutation typed-unavailable until record-store cutover.
