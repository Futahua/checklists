...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `ab9ca57` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `ab9ca57` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 131 files / 770 tests |
...
slice 20; keep every eventual mutation typed-unavailable until record-store cutover.
