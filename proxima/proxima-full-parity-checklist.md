...
| | |
| --- | --- |
| Accepted branch | `stage0-action-spine` @ `4801bad` — pushed, accepted slices only |
| Unaccepted work | none |
| Suite at `4801bad` | typecheck 0, build 0, `git diff --check` 0, vitest 0, 130 files / 766 tests |
...
slice 19; keep every eventual mutation typed-unavailable until record-store cutover.
